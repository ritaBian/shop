  ...
  methods: {
    SetSelectedPromotion(){
        if (this.$store.state.detail.carList != "" && this.$store.state.detail.carList.length>0)
        {
            ...
            {
              if(this.$store.state.detail.carList[k]['promotion_id']!="0")
              {
                for (let o = 0; o < this.$store.state.detail.carList[k].promotion.length; o++)
                {
                  if(this.$store.state.detail.carList[k]['promotion_id']==this.$store.state.detail.carList[k].promotion[o]['ID'])
                  {
